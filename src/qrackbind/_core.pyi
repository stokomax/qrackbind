...
class NoisyBase(enum.Enum):
    """Underlying engine base for QrackNoisySimulator."""
    SIMULATOR: NoisyBase
    STABILIZER_HYBRID: NoisyBase

class QrackNoisySimulator:
    """
    Quantum simulator with depolarizing noise injected around every gate.

    IMPORTANT: state_vector returns a single trajectory sample, not the ensemble.
    ...
    def __init__(
        self,
        qubitCount: int = 0,
        base: NoisyBase = NoisyBase.SIMULATOR,
    ...
    def __repr__(self) -> str: ...
    def __enter__(self) -> QrackNoisySimulator: ...
    def __exit__(self, exc_type: object | None, exc_val: object | None, exc_tb: object | None) -> None: ...

    # ── Gates (same surface as QrackSimulator) ───────────────────────────────
    def h(self, qubit: int) -> None: ...
    def x(self, qubit: int) -> None: ...
    def y(self, qubit: int) -> None: ...
    def z(self, qubit: int) -> None: ...
    ...
    # ── Noise control ────────────────────────────────────────────────────────
    def set_noise_parameter(self, lambda_: float) -> None:
        """Set depolarizing channel strength (0.0 = pass-through)."""
    def get_noise_parameter(self) -> float:
        """Current depolarizing channel strength."""
    def depolarizing_channel_1qb(self, qubit: int, lambda_: float) -> None:
        """Apply explicit single-qubit depolarizing channel of strength lambda_."""
    @property
    def unitary_fidelity(self) -> float:
        """Accumulated fidelity vs ideal unitary evolution. Starts at 1.0."""
    def reset_unitary_fidelity(self) -> None:
        """Reset accumulated unitary fidelity to 1.0."""

    # ── Properties and state management ─────────────────────────────────────
    @property
    def num_qubits(self) -> int: ...
    @property
    def base(self) -> NoisyBase:
        """Underlying engine base this noisy layer wraps."""
    def sample_trajectories(self, shots: int) -> dict[int, int]:
...
class QrackNoisyStabilizerHybrid:
    """
    ...
    def __repr__(self) -> str: ...
    def __enter__(self) -> QrackNoisyStabilizerHybrid: ...
    def __exit__(self, exc_type: object | None, exc_val: object | None, exc_tb: object | None) -> None: ...

    # ── Gates (same as QrackNoisySimulator) ──────────────────────────────────
    def h(self, qubit: int) -> None: ...
    def x(self, qubit: int) -> None: ...
    def y(self, qubit: int) -> None: ...
    def z(self, qubit: int) -> None: ...
